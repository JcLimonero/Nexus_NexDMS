...
export class InitialSchema1773629731772 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('ADMIN', 'MANAGER', 'WAREHOUSE', 'CASHIER', 'MECHANIC', 'SELLER')`);
        await queryRunner.query(`CREATE TYPE "public"."users_scope_enum" AS ENUM('GLOBAL', 'BRAND', 'BRANCH')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_01d93d1f1a8df7db7ae65751cb" ON "users" ("brand_id") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."brands_type_enum" AS ENUM('MOTO', 'AUTO', 'BOTH')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_c2c16397fa98d34f8db37684c4" ON "branches" ("slug") `);
        await queryRunner.query(`CREATE INDEX "IDX_608e52a910eeaeee5248786ae4" ON "branches" ("brand_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_fda619979f40a6a44fc9baf02c" ON "branches" ("tenant_id") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_57c5cc3c2bee98f88caffc317e" ON "branches" ("tenant_id", "slug") `);
        await queryRunner.query(`CREATE TABLE "branch_config" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "branch_id" uuid NOT NULL, "whatsapp_phone_id" text, "whatsapp_token" text, "facturaapi_api_key" text, "bank_name" character varying(100), "bank_clabe" character varying(18), "bank_account" character varying(20), "bank_holder" character varying(300), "cfdi_last_folio" integer NOT NULL DEFAULT '0', "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_54c43a1f8bf18614dfd4483977f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_3db9702e8f1c4b633788a29e93" ON "branch_config" ("branch_id") `);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."IDX_3db9702e8f1c4b633788a29e93"`);
        await queryRunner.query(`DROP TABLE "branch_config"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_57c5cc3c2bee98f88caffc317e"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_fda619979f40a6a44fc9baf02c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_608e52a910eeaeee5248786ae4"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_01d93d1f1a8df7db7ae65751cb"`);
