// Los adjuntos viven en su propio archivo: `whatsapp-bot.service.spec.ts`
// cubre el escalamiento, con otros mocks y otro montaje. Juntarlos obligaba a
// un setup que sirviera para las dos cosas y no describía bien ninguna.
...
describe('WhatsappBotService · adjuntos', () => {
