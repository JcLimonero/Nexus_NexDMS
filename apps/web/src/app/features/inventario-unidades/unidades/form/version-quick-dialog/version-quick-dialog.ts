...
@Component({
  selector: "app-version-quick-dialog",
  standalone: true,
    ...
    <form [formGroup]="form" (ngSubmit)="submit()">
      <div class="modal-body">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" formControlName="name" placeholder="Ej: Sport, EX" />
...
export class VersionQuickDialog {
  ...
  submit(): void {
    if (this.form.invalid || this.saving || !this.brandId || !this.modelId) return;
    ...
    this.vehicleVersionsService
      ...
      .subscribe({
        ...
        error: (err) => {
          this.saving = false;
          this.error = err?.error?.message || "Error al crear versión";
        },
      });
  }
}
