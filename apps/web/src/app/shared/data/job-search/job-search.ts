export interface JobDetailSection {
  title: string;
  desc: string; // raw HTML string, you may sanitize it later using DomSanitizer
}
...
export interface JobCategory {
  ...
  Qualifications: JobDetailSection;
  Agency_experience: JobDetailSection;
  Perks: JobDetailSection;
  type?: string;
  ribbon?: string | boolean;
}

export class JobDB {
  static Job_Category: JobCategory[] = [
    {
      Id: 1,
