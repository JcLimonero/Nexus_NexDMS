    ...
    this.ɵcmp = ɵɵdefineComponent({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG__USERS_JCLIMONERO_DEVELOPER_NEXDMS_NEXUS_NEXDMS_APPS_WEB_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_PAGINATION_MJS_0 = goog.getMsg("««");
          i18n_0 = MSG__USERS_JCLIMONERO_DEVELOPER_NEXDMS_NEXUS_NEXDMS_APPS_WEB_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_PAGINATION_MJS_0;
        } else {
          i18n_0 = $localize`:@@ngb.pagination.first:««`;
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG__USERS_JCLIMONERO_DEVELOPER_NEXDMS_NEXUS_NEXDMS_APPS_WEB_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_PAGINATION_MJS_1 = goog.getMsg("«");
          i18n_1 = MSG__USERS_JCLIMONERO_DEVELOPER_NEXDMS_NEXUS_NEXDMS_APPS_WEB_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_PAGINATION_MJS_1;
        } else {
          i18n_1 = $localize`:@@ngb.pagination.previous:«`;
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG__USERS_JCLIMONERO_DEVELOPER_NEXDMS_NEXUS_NEXDMS_APPS_WEB_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_PAGINATION_MJS_2 = goog.getMsg("»");
          i18n_2 = MSG__USERS_JCLIMONERO_DEVELOPER_NEXDMS_NEXUS_NEXDMS_APPS_WEB_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_PAGINATION_MJS_2;
        } else {
          i18n_2 = $localize`:@@ngb.pagination.next:»`;
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG__USERS_JCLIMONERO_DEVELOPER_NEXDMS_NEXUS_NEXDMS_APPS_WEB_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_PAGINATION_MJS_3 = goog.getMsg("»»");
          i18n_3 = MSG__USERS_JCLIMONERO_DEVELOPER_NEXDMS_NEXUS_NEXDMS_APPS_WEB_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_PAGINATION_MJS_3;
        } else {
          i18n_3 = $localize`:@@ngb.pagination.last:»»`;
        }
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG__USERS_JCLIMONERO_DEVELOPER_NEXDMS_NEXUS_NEXDMS_APPS_WEB_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_PAGINATION_MJS_4 = goog.getMsg("First");
          i18n_4 = MSG__USERS_JCLIMONERO_DEVELOPER_NEXDMS_NEXUS_NEXDMS_APPS_WEB_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_PAGINATION_MJS_4;
        } else {
          i18n_4 = $localize`:@@ngb.pagination.first-aria:First`;
        }
        let i18n_5;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG__USERS_JCLIMONERO_DEVELOPER_NEXDMS_NEXUS_NEXDMS_APPS_WEB_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_PAGINATION_MJS_5 = goog.getMsg("Previous");
          i18n_5 = MSG__USERS_JCLIMONERO_DEVELOPER_NEXDMS_NEXUS_NEXDMS_APPS_WEB_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_PAGINATION_MJS_5;
        } else {
          i18n_5 = $localize`:@@ngb.pagination.previous-aria:Previous`;
        }
        let i18n_6;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG__USERS_JCLIMONERO_DEVELOPER_NEXDMS_NEXUS_NEXDMS_APPS_WEB_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_PAGINATION_MJS_6 = goog.getMsg("Next");
          i18n_6 = MSG__USERS_JCLIMONERO_DEVELOPER_NEXDMS_NEXUS_NEXDMS_APPS_WEB_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_PAGINATION_MJS_6;
        } else {
          i18n_6 = $localize`:@@ngb.pagination.next-aria:Next`;
        }
        let i18n_7;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG__USERS_JCLIMONERO_DEVELOPER_NEXDMS_NEXUS_NEXDMS_APPS_WEB_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_PAGINATION_MJS_7 = goog.getMsg("Last");
          i18n_7 = MSG__USERS_JCLIMONERO_DEVELOPER_NEXDMS_NEXUS_NEXDMS_APPS_WEB_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_PAGINATION_MJS_7;
        } else {
...
//# sourceMappingURL=chunk-U4ZWGXWS.js.map
