  ...
  onStart(pointerType, event, bindMove, bindEnd, simulateImmediateMove, simulateImmediateEnd) {
    ...
    if (bindMove) {
      ...
      if (event.pointerType === "touch") {
        this.onMoveEventListener = this.eventListenerHelper.attachPassiveEventListener(this.document, "pointermove", onMoveCallback);
      } else {
    ...
    if (bindEnd) {
      ...
      if (event.pointerType === "touch") {
        this.onEndEventListener = this.eventListenerHelper.attachPassiveEventListener(this.document, "pointerup", onEndCallback);
